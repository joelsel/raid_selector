...
terminus = ("\n{:-^60}{}, {}, {}, {}\n "
.format(" end of output ", cnt_tank, cnt_healer, cnt_melee, cnt_ranged ))
...
def class_picker_main(class_sample, role_sample, spec_sample):
    global line_output
...
if cycle_count < 0:
    ...
    for cyc in range(cycle_count):
        ...
        class_picker_main(class_sample, role_sample, spec_sample) # needs ID, role, class, spec variables passed to write_file
#except: ValueError
write_file(line_output) # write_file not currently working
print("Value error")
...
while prog_init == 1:
    try:
        run_choice = int(input("Main Menu: Press 1 for class_dev, Press 2 for Class Picker v1: "))
