...
global terminus
terminus = ("\n{:-^60} {} {} {}\n "
.format(" end of output ","test output", cnt_healer, cnt_melee))
...
def write_file(line_output,cycle_count,terminus):
    while True:
            try:
                ...
                if write_mode == 0:
                    with open("hello.txt", "w") as f:
                        ...
                        #f.write("".join(terminus(cnt_tank, cnt_healer, cnt_melee, cnt_ranged)))
                    break
                elif write_mode == 1:
...
def class_picker_v2():
    ...
    #except: ValueError
        print (line_output)
        write_file(line_output, cycle_count, terminus) # write_file not currently working
        print("Value error")
...
#TODO 20220807 - cnt_* variables are logged correctly at write stage,  not joined into terminus correctly
